...
1. Before running the program to install the language program Python 3.13.2 on the PC, which can be downloaded in: https://www.python.org/downloads/, and download the files in the folder DiDePT/DiDePT Analysis.
   or
2. Download the file 'main_for_tif.exe' found in the "releases" with the tag "Data Analysis DiDePT v1.0" in the right of the screen. You can use the folder 'photos_treatments_06052026' to do a first try, please put this file in the same folder as the executable 'data_analysis_main.exe'.
